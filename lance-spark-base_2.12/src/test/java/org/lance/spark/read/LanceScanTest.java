...
public class LanceScanTest {
  ...
  public void testEqualsForIdenticalScans() {
    // Two scans built from the same read options should be equal.
    // This is required for Spark's ReusedExchange optimization:
    // BatchScanExec.equals() compares batch objects, which delegates
    // to LanceScan.equals() since LanceScan implements Batch.
