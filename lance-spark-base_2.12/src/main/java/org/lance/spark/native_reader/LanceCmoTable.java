...
/**
 * Parses the Column Metadata Offset (CMO) table from a Lance v2 file.
...
public class LanceCmoTable {
  ...
  public long getPosition(int columnIndex) { return positions[columnIndex]; }
  public long getSize(int columnIndex) { return sizes[columnIndex]; }
  public int getNumColumns() { return positions.length; }
}
